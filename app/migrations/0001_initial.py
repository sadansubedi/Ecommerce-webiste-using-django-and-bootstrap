# Generated by Django 3.2 on 2023-05-05 02:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Province No. 1', 'Koshi Province'), ('Province No. 2', 'Madhes Province'), ('Province No. 3', 'Bagmati Province'), ('Province No. 4', 'Gandaki Province'), ('Province No. 5', 'Lumbini Province'), ('Province No. 6', 'Karnali Province'), ('Province No. 7', 'Sudurpashchim Province')], max_length=200)),
